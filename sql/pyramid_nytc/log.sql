...
select  *,
        ...
        morton_dec_x( zooatlevel(cast(2 as smallint), cast(31 as smallint), lev, zoo)) as x,
        morton_dec_y( zooatlevel(cast(2 as smallint), cast(31 as smallint), lev, zoo)) as y
from    pyramid
where   lev = 17;
